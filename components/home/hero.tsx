    ...
    <>
      <section className="relative overflow-hidden min-h-screen flex flex-col">
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          ...
          <div className="mx-auto max-w-full text-center flex-1 flex flex-col justify-center">
            {/* Badge */}
            <motion.div
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 id="main-title max-w-full">
                <span className="text-6xl font-bold text-foreground sm:text-6xl lg:text-8xl tracking-normal">Share</span> &nbsp;&nbsp;
                <strong className="text-6xl font-bold text-foreground sm:text-6xl lg:text-8xl tracking-normal">Free</strong> 
                <br />
                <span className="flex flex-col lg:flex-row md:flex-row xl:flex-row">
                  <span>
                    <strong className="text-4xl font-bold tracking-normal text-foreground sm:text-6xl lg:text-4xl ">Share videos, Music,</strong> 
                  </span>
                  <span className="">
                    <strong className="text-4xl font-bold tracking-normal text-foreground sm:text-6xl lg:text-4xl">&nbsp;Doc's </strong>
                    <span className="text-4xl font-bold tracking-normal text-foreground sm:text-6xl lg:text-4xl"><em className="italic">&</em>  &nbsp;</span> 
                    
                    <span className="relative">
                      <strong className="text-4xl font-bold tracking-normal text-foreground sm:text-6xl lg:text-4xl">more.. </strong>
                      <img className="absolute 
                                      h-[35px] md:h-[70px] lg:h-[70px] xl:h-[70px] 
                                      top-[-15px] md:top-[-70px] lg:top-[-70px] xl:top-[-50px]  
                                      right-[-40px] md:right-[-70px] lg:right-[-70px] xl:right-[-70px]
                                      " 
                                      src="/send.png" alt="" 
                                      />
                    </span>
            ...
            >
              Freedom to share anything. Fast uploads, smooth watching, <br /> zero content restrictions
            </motion.p>
            ...
            >
              ...
              <div className="flex items-center justify-center">
                <a href="/docs/components/theme-toggle-animations">
                  <div className="group cursor-pointer bg-secondary border border-border gap-2 h-[60px] flex items-center p-[10px] rounded-full">
