...
// import MoveButtons from button-move
  ...
  return (
    <section id="features" className="text-foreground relative overflow-hidden py-12 sm:py-24 md:py-32">
      ...
      >
        ...
        <h2
          className={cn(
            "via-foreground mb-8 bg-gradient-to-b from-zinc-800  bg-clip-text text-center text-4xl font-semibold tracking-tighter text-transparent md:text-[54px] md:leading-[60px]",
            geist.className,
          )}
        >
          Features
            ...
            <div className="grid grid-cols-12 gap-4 justify-center">
              ...
              <motion.div
                ...
                whileHover={{
                  scale: 1.02,
                  borderColor: "#d0ffc8",
                  boxShadow: "0 0 30px #dbfed5",
                }}
                style={{ transition: "all 0s ease-in-out" }}
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Speed. Freedom. Flow.</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Fast uploads, smooth playback, zero content restrictions, and no video auto-deletions. 
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Smart Share Links</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Share your content anywhere with unique links for every platform. Track views 
                    </p>
                  </div>
                </div>
                <div className="flex min-h-[300px] grow items-start justify-center select-none">
                  <h1 className="mt-8 text-center text-5xl leading-[100%] font-semibold sm:leading-normal lg:mt-12 lg:text-6xl">
                    <span className='bg-background relative mt-3 inline-block w-fit rounded-md border px-1.5 py-0.5 before:absolute before:top-0 before:left-0 before:z-10 before:h-full before:w-full before:bg-[url("/noise.gif")] before:opacity-[0.09] before:content-[""]'>
                      <ScrambleHover
                        ...
                        className="cursor-pointer bg-gradient-to-t from-[#2dff0a6e] to-[#2dff0a6e] bg-clip-text text-transparent"
                  ...
                  <div className="absolute top-64 z-10 flex items-center justify-center">
                    <div className="w-[400px] h-[400px] blur-[1px]">
                      {/* <Suspense
                        fallback={
                      ...
                      >
                        <Earth 
                          // baseColor={baseColor} 
                          baseColor={[45 / 255, 200 / 255, 10 / 255]} // Set the new base color
                          markerColor={[0, 0, 0]} 
                          glowColor={glowColor} 
                          dark={dark} 
                        />
                      ...
                      {/* <GlobeDemo /> */}
                      {/* <img src="/Gemini_Generated_Image_ip2uysip2uysip2u.png" alt="" /> */}
                      <img 
                          // src="/share2.png"
                          // src="/d27de5fb-1f99-41f9-937a-7537d4f017f7.png"
                          src="/61591570-8a50-48a5-a6ba-5a6b5791c748.png"
                          alt="" 
                          className="w-full h-full object-cover rounded-xl" />
                    </div>
                  </div>
